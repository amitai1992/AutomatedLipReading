...
path_to_model = "\saved_model_80ep_w_dropout_data_faces.json"
dir_for_testset = "ordered_dataset/two letters/test"
path_for_weights = "\weights_80ep_w_dropout_data_faces.h5"


# In[3]:


test_data_gen = test_image_generator.flow_from_directory(dir_for_testset,
                                                   shuffle=False,
                                                   frames_per_step=15,
                                                   save_format='jpg',
                                                   color_mode='rgb',
...
with open(path_to_model) as json_file:
...
model.load_weights(path_for_weights)
...
results_test = model.evaluate(test_data_gen, steps=1035 // 15)
