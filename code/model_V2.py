...
train_generator = datagen.flow_from_directory(path_for_trainset,shuffle=False,frames_per_step=15,save_format='jpg',color_mode='grayscale', target_size=(100, 100))
validation_generator = datagen.flow_from_directory(path_for_validationset,shuffle=False,frames_per_step=15,save_format='jpg',color_mode='grayscale', target_size=(100, 100))
...
from keras.layers import Dense, Dropout, Activation, Flatten, Conv3D, MaxPooling3D,TimeDistributed,GRU
...
shape = (15, 100, 100, 1)
model = Sequential()
model.add(Conv3D(8,(3,3,3), padding='same', activation='relu',input_shape=shape))
model.add(MaxPooling3D(padding='same'))
...
model.fit_generator(train_generator,
        steps_per_epoch=59906//256,
        epochs=4,
        validation_steps=4785//256,
